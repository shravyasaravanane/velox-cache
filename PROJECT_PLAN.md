...
- [ ] *(M6.3-M6.5 remain (Internals Visualizer, Policy Arena, heat map). M6.3/M6.4 in particular need new introspection APIs on velox-core's policies, a real backend design decision, not just wiring. Tier 6 checkpoint still deferred until you decide how far to take this.)*
