...
- [ ] *(M6.3-M6.4 remain (Internals Visualizer, Policy Arena) -- both need new introspection APIs on velox-core's policies, a real backend design decision, not just wiring. Tier 6 checkpoint still deferred until you decide how far to take this.)*
